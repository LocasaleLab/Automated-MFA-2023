from . import colon_cancer_cell_line_with_glns_m
from .colon_cancer_cell_line_with_glns_m import *
from .colon_cancer_cell_line_with_glns_m import total_param_list as raw_total_param_list, \
    project_name_generator as raw_project_name_generator, keyword_list as raw_keyword_list

name = 'colon_cancer_cell_line_with_glns_m_traditional_method'
...
parent_data_model_obj = colon_cancer_cell_line_with_glns_m
parent_result_name = colon_cancer_cell_line_with_glns_m.name
