from . import renal_carcinoma_invivo_infusion
...
name = 'renal_carcinoma_invivo_infusion_traditional_method'
...
parent_data_model_obj = renal_carcinoma_invivo_infusion
parent_result_name = renal_carcinoma_invivo_infusion.name
