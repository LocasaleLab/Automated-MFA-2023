...
from ..common.common_figure_materials import CommonFigureString, DataName, CommonFigureMaterials


Subfigure = Elements.Subfigure
single_data_figure_scale = 0.4
grid_data_figure_scale = 0.46
...
# raw_distance_title = CommonFigureString.raw_euclidean_distance
raw_distance_title = CommonFigureString.raw_distance_to_known_flux
...
class SubfigureA(Subfigure):
    ...
    def __init__(self, subfigure_bottom_left=None, subfigure_size=None):
        figure_data_parameter_dict = {
            ...
            ParameterName.figure_subtitle: raw_distance_title,
        ...
        scale = single_data_figure_scale
...
class SubfigureC(Subfigure):
    subfigure_label = 'c'
    subfigure_title = 'averaged_reoptimized_solution_comparison_all_data'

    def __init__(self, subfigure_bottom_left=None, subfigure_size=None):
        figure_data_parameter_dict = {
            ParameterName.figure_title: CommonFigureString.averaged_reoptimized_solution_difference,
            ParameterName.figure_subtitle: CommonFigureString.optimization_selection_title_constructor(
                all_data_optimized_size, all_data_selection_size),
            ParameterName.data_name: DataName.optimization_from_solutions_all_data,
...
class SubfigureH(Subfigure):
    subfigure_label = 'h'
    subfigure_title = 'averaged_reoptimized_solution_comparison_raw_data'
...
class SubfigureI(Subfigure):
    ...
    def __init__(self, subfigure_bottom_left=None, subfigure_size=None):
        figure_data_parameter_dict = {
            ...
            ParameterName.selection_size: raw_data_selection_size,
            ParameterName.loss_data_figure_parameter_dict: {
                ParameterName.common_y_lim: [0, 0.45],
