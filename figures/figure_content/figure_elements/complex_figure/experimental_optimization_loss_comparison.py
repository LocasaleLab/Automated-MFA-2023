from ...common.config import DataFigureConfig, DataFigureParameterName as ParameterName, Vector, \
    FontWeight, CompositeFigure, default_parameter_extract, CommonElementConfig
from ...common.common_figure_materials import CommonFigureMaterials
from ..data_figure.violin_box_data_figure import ExperimentalOptimizationLossComparisonBoxDataFigure
