...
class MIDComparisonGridBarWithLegendDataFigure(CompositeFigure):
    ...
    def __init__(
        ...
        # grid_figure_height = 0.76 * total_width
        # legend_bottom = grid_figure_height + 0.005 * total_width
        ...
        mid_comparison_config_dict = {
            ...
            ParameterName.figure_data_parameter_dict: {
                ...
                # ParameterName.mid_name_list: CommonFigureMaterials.default_mid_name_list,
