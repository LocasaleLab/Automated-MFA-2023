...
from ..common.common_figure_materials import MetabolicNetworkConfig, FigureConfig, DataName, \
    ProtocolSearchingMaterials, CommonFigureString, calculate_center_bottom_offset
    ...
    def __init__(self):
        ...
        subfigure_obj_list.extend([
            ...
            single_subfigure_layout(
                ...
                side_margin_ratio),
            single_subfigure_layout(
                subfigure_i_center, subfigure_i_size, SubfigureI, height_to_width_ratio, top_margin_ratio,
                side_margin_ratio),
            single_subfigure_layout(
                subfigure_j_center, subfigure_j_size, SubfigureJ, height_to_width_ratio, top_margin_ratio,
                side_margin_ratio),
        ])
