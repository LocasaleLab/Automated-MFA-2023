from ...common.third_party_packages import np, transforms, plt
from ...common.config import float_type, axis_for_test, ParameterName, figure_path_generator, Constant
...
# class Figure(Subplot):
class Figure(CompositeFigure):
    def __init__(
            self, figure_name, subfigure_dict, figure_size=None, figure_title=None, dpi=None,
            save_path=None):
        ...
        # if isinstance(subfigure_dict, dict):
        #     content_list = list(subfigure_dict.values())
        # else:
        #     content_list = subfigure_dict
        # super().__init__(Vector(0, 0), Vector(1, 1), content_list, name=figure_name)
        ...
        figure_element_dict = {ParameterName.subfigure: subfigure_dict}
    ...
    def draw(self, fig=None, parent_ax=None, parent_transformation=None):
        ...
        if self.save_path is None:
            save_path = figure_path_generator(self.figure_name)
        else:
