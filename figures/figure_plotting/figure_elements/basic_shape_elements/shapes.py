from ...common.built_in_packages import enum
from ...common.third_party_packages import np, mpath, mpatches, transforms, mlines
from ...common.classes import Color, Vector, black_color, LineStyle, JoinStyle

from ..common_functions import rotate_corner_offset_around_center, calculate_top_right_point, \
