from ...common.color import ColorConfig, ZOrderConfig, TextConfig
from ...common.config import ParameterName
from ...common.third_party_packages import np
from ...common.built_in_packages import it
from ...common.classes import Vector, VerticalAlignment, HorizontalAlignment

from ..common_functions import initialize_vector_input, default_parameter_extract
...
def common_legend_generator(legend_config_dict, color_dict):
    # try:
    #     legend_type = legend_config_dict[ParameterName.legend_type]
    # except KeyError:
    #     legend_type = ParameterName.patch_legend
    legend_type = default_parameter_extract(legend_config_dict, ParameterName.legend_type, ParameterName.patch_legend)
    # try:
    #     horiz_or_vertical = legend_config_dict[ParameterName.horiz_or_vertical]
    # except KeyError:
    #     horiz_or_vertical = ParameterName.horizontal
    horiz_or_vertical = default_parameter_extract(
        legend_config_dict, ParameterName.horiz_or_vertical, ParameterName.horizontal)
    # try:
    #     shape = legend_config_dict[ParameterName.shape]
    # except KeyError:
    #     shape = ParameterName.rectangle
    shape = default_parameter_extract(
        legend_config_dict, ParameterName.shape, ParameterName.rectangle)
    # try:
    #     alpha = legend_config_dict[ParameterName.alpha]
    # except KeyError:
    #     alpha = ColorConfig.alpha_for_bar_plot
    ...
    if legend_type == ParameterName.patch_legend:
        ...
        legend_obj = PatchLegend(
            legend_area_center, legend_width, legend_height, color_dict, name_dict, shape=shape,
