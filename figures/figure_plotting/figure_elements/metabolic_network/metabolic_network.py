from .config import DataName, Vector, ParameterName, NetworkGeneralConfig, LegendConfig
from .config import CompositeFigure, TextBox, flux_value_mapper_dict, SensitivityConfig, ReactionConfig, \
    MetaboliteConfig, TextCommentConfig, ModelDataSensitivityDataFigureConfig, \
    CommonFigureString

from .layout_generator_functions import network_layout_generator, exchange_partial_network_layout_generator, \
    legend_layout_generator, text_comment_layout_generator, metabolic_sensitivity_network_layout_generator, \
    data_availability_sensitivity_layout_generator, config_sensitivity_layout_generator, \
    multi_tissue_network_layout_generator
from .metabolic_network_contents import MetaboliteList, ReactionList, SubnetworkList, assign_value_to_network, \
    assign_flux_name_to_network, NetworkSensitivityDiagramMetabolite, NetworkSensitivityDiagramReaction
...
class ExchangeMetabolicNetwork(CompositeFigure):
    ...
    def __init__(
        ...
        # metabolic_element_dict = set_and_convert_network_elements(
        #     metabolite_list, reaction_list, subnetwork_list, other_text_list,
        #     display_flux_name=display_flux_name, reaction_raw_value_dict=reaction_raw_value_dict,
        #     flux_value_mapper=flux_value_mapper)
        metabolic_element_dict = set_and_convert_network_elements(
            metabolite_list, reaction_list, subnetwork_list, other_text_list,
            input_metabolite_set=input_metabolite_set, c13_labeling_metabolite_set=c13_labeling_metabolite_set,
            mid_data_metabolite_set=mid_data_metabolite_set,
