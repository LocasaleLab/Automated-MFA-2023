...
class Metabolite(object):
    def __init__(self, metabolite_name: str, center: Vector = None, display_metabolite_name=None, **kwargs):
        ...
        self.data_sensitivity_state = None
    ...
    def set_data_sensitivity_state(self, data_sensitivity_state):
        self.data_sensitivity_state = data_sensitivity_state
        return self
