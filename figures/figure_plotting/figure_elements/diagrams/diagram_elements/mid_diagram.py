from ...common_functions import construct_full_name, basic_shape_parameter_set, \
    load_required_parameter, text_parameter_set

from .config import warnings, np, Vector, Keyword, ParameterName, ZOrderConfig, ColorConfig, TextConfig, \
    JoinStyle, VerticalAlignment, HorizontalAlignment, common_text_config_dict
...
class MIDDiagramConfig(object):
    ...
    box_config_dict = {
        Keyword.blue: blue_box_config,
        Keyword.orange: orange_box_config,
    }
    ...
    bar_config_dict = {
        Keyword.blue: blue_bar_config,
        Keyword.orange: orange_bar_config,
        Keyword.gray: gray_bar_config,
    }
...
class MIDDiagram(CompositeFigure):
    ...
    def __init__(
            self, data_vector: np.ndarray, color_name=Keyword.blue,
