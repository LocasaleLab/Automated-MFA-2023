from ..config import Vector, ParameterName, VerticalAlignment, HorizontalAlignment, LineStyle, FontWeight, \
    CommonFigureMaterials, ColorConfig
from ..config import Circle, Arrow
from .axis_diagram import bidirectional_arrow_config_constructor
from .protocol_diagram import ProtocolDiagram, ProtocolDiagramConfig
    ...
    def __init__(self, **kwargs):
        ...
        text_config_list.append({
            **RandomOptimizedDistanceDiagramConfig.global_optimum_text_config,
            ParameterName.string: 'Best optimized\nsolution',
